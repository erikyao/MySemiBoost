...
def cross_validate(estimator, X, y=None, groups=None, scoring=None, cv=None,
    ...
    decision_scores : dict of float arrays of shape=(n_splits,)
        Array of decision_scores of the estimator for each run of the cross validation.
...
def cross_val_score(estimator, X, y=None, groups=None, scoring=None, cv=None,
    ...
    Returns
    -------
    decision_scores : array of float, shape=(len(list(cross_validators)),)
        Array of decision_scores of the estimator for each run of the cross validation.
    ...
    :func:`sklearn.model_selection.cross_validate`:
        ...
        train decision_scores, fit times and score times.
...
def permutation_test_score(estimator, X, y, groups=None, cv=None,
    ...
    permutation_scores : array, shape (n_permutations,)
        The decision_scores obtained for each permutations.
...
def learning_curve(estimator, X, y, groups=None,
    ...
    Determines cross-validated training and test decision_scores for different training
    set sizes.

    A cross-validation generator splits the whole dataset k times in training
    and test data. Subsets of the training set with varying sizes will be used
    to train the estimator and a score for each training subset size and the
    test set will be computed. Afterwards, the decision_scores will be averaged over
...
def _incremental_fit_estimator(estimator, X, y, classes, train, test,
    ...
    """Train estimator on training subsets incrementally and compute decision_scores."""
...
def validation_curve(estimator, X, y, param_name, param_range, groups=None,
    ...
    Determine training and test decision_scores for varying parameter values.

    Compute decision_scores for an estimator with different values of a specified
    parameter. This is similar to grid search with one parameter. However, this
    will also compute training decision_scores and is merely a utility for plotting the
    results.
    ...
    out = parallel(delayed(_fit_and_score)(
        ...
        # NOTE do not change order of iteration to allow one time cross_validators splitters
